...
.Lc8:
# Temps allocated between r13+12 and r13+92
# [61] begin
	push	{r4,r5,r6,r7,r14}
	sub	r13,r13,#168
# Var num located at r13+0, size=OS_32
# Var pin located at r13+4, size=OS_32
# Var tmp located at r13+8, size=OS_32
# Var data_size located in register r5
# Var size located in register r0
# Var i located in register r4
# Var j located in register r4
# Var rcv located in register r6
# Var page located in register r7
	ldr	r0,[r13, #84]
	uxtb	r0,r0
	str	r0,[r13, #84]
# Var tcb_id located in register r0
	mov	r4,r1
# Var rcv_data located in register r4
	uxth	r5,r2
...
.Lj42:
	.long	U_$P$PROJECT_ETH_$$_OUTPUT_PIN-48
.Lj43:
