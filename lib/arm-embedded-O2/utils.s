...
# [49] begin
	...
	sub	r13,r13,#40
	mov	r2,r0
# Var Value located in register r2
	uxtb	r0,r1
# Var Index located in register r0
...
.Lc10:
# Temps allocated between r13+4 and r13+316
# [62] begin
	push	{r4,r5,r14}
	sub	r13,r13,#384
...
# Var Port located in register r0
	uxth	r2,r1
# Var pins located in register r2
# [69] case Port of
	cmp	r0,#0
	bne	.Lj32
	bl	.Lj28
...
# Var Port located in register r0
	uxth	r2,r1
# Var pin located in register r2
# [111] case Port of
	cmp	r0,#0
	bne	.Lj102
	bl	.Lj98
...
# Var Port located in register r0
	uxth	r3,r1
# Var pin located in register r3
# [121] case Port of
	cmp	r0,#0
	bne	.Lj117
	bl	.Lj113
