...
# Var data located in register r0
	uxtb	r4,r0
# Var op located in register r4
	uxtb	r5,r1
# Var address located in register r5
# [285] ENC28J60_CS_ON;
...
# [287] data := SPI_Read(0);
	...
	uxtb	r4,r0
# Var data located in register r4
...
# [295] begin
	...
	sub	r13,r13,#40
	uxtb	r5,r0
# Var op located in register r5
	uxtb	r4,r1
# Var address located in register r4
	uxtb	r6,r2
...
# [304] begin
	...
	sub	r13,r13,#40
	uxth	r4,r0
# Var len located in register r4
	mov	r5,r1
# Var data located in register r5
# [305] ENC28J60_CS_ON;
	bl	ENC28J60_$$_ENC28J60_CS_ON
...
# [401] begin
	...
	sub	r13,r13,#40
# Var $result located in register r0
# Var rev located in register r0
...
# [418] begin
	...
	sub	r13,r13,#40
	mov	r4,r0
# Var macaddr located in register r4
...
# [490] ENC28J60_Write(MAADR1, (macaddr+4)^);
	...
	mov	r0,#224
	bl	ENC28J60_$$_ENC28J60_WRITE$BYTE$BYTE
# Var macaddr located in register r0
...
# [505] begin
	...
	sub	r13,r13,#48
# Var $result located in register r0
# Var len located in register r5
# Var rxstat located in register r4
	uxth	r6,r0
# Var maxlen located in register r6
	mov	r7,r1
# Var packet located in register r7
...
# Var len located in register r5
	mov	r4,r1
# Var packet located in register r4
...
# [582] ENC28J60_WriteBuffer(len, packet);
	mov	r1,r4
# Var packet located in register r1
	mov	r0,r5
# Var len located in register r0
	uxth	r0,r0
