...
# [77] begin
	push	{r14}
	sub	r13,r13,#40
# Var a located at r13+0, size=OS_16
...
# [82] begin
	push	{r14}
	sub	r13,r13,#40
# Var a located at r13+0, size=OS_32
...
# Var ETH_Header located at r13+4, size=OS_32
	str	r0,[r13]
...
# [120] begin
	push	{r14}
	sub	r13,r13,#40
# Var data_buffer located at r13+0, size=OS_32
# Var rcv_size located at r13+4, size=OS_16
	str	r0,[r13]
# [118] var
	ldr	r0,.Lj32
	ldrh	r1,[r0]
...
# Var sck_type located at r13+4, size=OS_8
# Var curr located at r13+8, size=OS_32
	str	r0,[r13]
	add	r0,r13,#4
	strb	r1,[r0]
...
# [155] begin
	...
	sub	r13,r13,#40
# Var socket located at r13+0, size=OS_32
# Var curr located at r13+4, size=OS_32
	str	r0,[r13]
...
# Var socketPtr located at r13+8, size=OS_32
# Var count located at r13+12, size=OS_16
	str	r0,[r13]
# [175] var
	ldr	r0,.Lj78
	ldrh	r1,[r0]
...
# Var socketPtr located at r13+12, size=OS_32
# Var count located at r13+16, size=OS_16
	mov	r2,r13
	strh	r0,[r2]
	add	r0,r13,#4
	strb	r1,[r0]
...
# [241] begin
	...
	sub	r13,r13,#40
# Var socket located at r13+0, size=OS_32
# Var func located at r13+4, size=OS_32
	str	r0,[r13]
	str	r1,[r13, #4]
...
# [246] begin
	push	{r14}
	sub	r13,r13,#40
# Var id located at r13+0, size=OS_8
...
# [260] begin
	push	{r14}
	sub	r13,r13,#40
# Var it located at r13+0, size=OS_16
