...
# Var sckpin located at r13+4, size=OS_8
# Var i located at r13+8, size=OS_32
# Var v located at r13+12, size=OS_32
	mov	r2,r13
	strb	r0,[r2]
	add	r0,r13,#4
	strb	r1,[r0]
...
.Lj40:
	bl	.Lj36
.Lj38:
# [68] v := v; // for clean warrnings "v not used"
	ldr	r0,[r13, #12]
	str	r0,[r13, #12]
...
# Var Dummy located at r13+8, size=OS_32
	mov	r2,r13
	strb	r0,[r2]
	add	r0,r13,#4
	strb	r1,[r0]
